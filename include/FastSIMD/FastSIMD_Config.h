...
#define FASTSIMD_COMPILE_SSE2   (FASTSIMD_x86 & MLE_LEVEL_SSE2 )
#define FASTSIMD_COMPILE_SSE3   (FASTSIMD_x86 & MLE_LEVEL_SSE3 )
#define FASTSIMD_COMPILE_SSSE3  (FASTSIMD_x86 & MLE_LEVEL_SSSE3 )
#define FASTSIMD_COMPILE_SSE41  (FASTSIMD_x86 & MLE_LEVEL_SSE41 )
#define FASTSIMD_COMPILE_SSE42  (FASTSIMD_x86 & MLE_LEVEL_SSE42 )
#define FASTSIMD_COMPILE_AVX    (FASTSIMD_x86 & false) // Not supported
#define FASTSIMD_COMPILE_AVX2   (FASTSIMD_x86 & MLE_LEVEL_AVX2 )
#define FASTSIMD_COMPILE_AVX512 (FASTSIMD_x86 & (MLE_LEVEL_AVX512_F && MLE_LEVEL_AVX512_DQ) )

#define FASTSIMD_COMPILE_NEON   (FASTSIMD_ARM & true )

#define FASTSIMD_USE_FMA                   MLE_LEVEL_FMA
